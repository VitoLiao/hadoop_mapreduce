...
public class ViewlogRowData {
	...
	private String serialFlag = new String();
	...
	public boolean isValid() {
		...
		if (0 == this.getUserId().length() || 0 == this.getStartTime().length() || 0 == this.getEndTime().length()
				 || 0 == this.getAreaCode().length() || 0 == this.getLogType().length() || 0 == this.getMediaCode().length()
				 || 0 == this.getHdFlag().length()) {
			return false;
		}
