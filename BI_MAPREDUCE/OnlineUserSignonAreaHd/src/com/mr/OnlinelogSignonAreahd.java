...
public class OnlinelogSignonAreahd {

	public static void main(String[] args) throws IOException, ParseException {

		ViewlogOptionUtil option = new ViewlogOptionUtil(args);

		String outputPath = "hdfs://" + option.getHdfsActiveHost() + ":" + option.getPort()
				+ "/utsc/output/online_signon_areahd_log";
		...
		Date calcStartTime = ViewlogDateUtil
				.getDayStartTime(ViewlogDateUtil.str2date(option.getCalcStartDate(), "yyyy-MM-dd"));
		Date calcEndTime = ViewlogDateUtil
				.getDayEndTime(ViewlogDateUtil.str2date(option.getCalcStartDate(), "yyyy-MM-dd"));
		...
		Job job01 = new Job(conf01, "online_signon_areahd_01");
		ControlledJob jobCtrl01 = new ControlledJob(conf01);

		jobCtrl01.setJob(job01);

		job01.setJarByClass(OnlinelogSignonAreahd.class);
