...
//		 String DFlag = "local";
		...
		if (DFlag.equals("local")) {
			...
			locationStrOut = "hdfs://10.80.248.12:8020/utsc/output/VLUserViewArea";
		} else if (DFlag.equals("online")) {
			locationStrIn = "hdfs://10.0.18.98:8020/utsc/input_log";
			locationStrOut = "hdfs://10.0.18.98:8020/utsc/output/VLUserViewArea";
		...
		// conf01.set("mapreduce.textoutputformat.separator", "|");
