...
public class PartViewUser {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		if (DFlag.equals("local")) {
			...
			locationStrOut = "hdfs://10.80.248.12:8020/utsc/output/VLPartViewUser";
		} else if (DFlag.equals("online")) {
			locationStrIn = "hdfs://10.0.18.98:8020/utsc/input_log";
			locationStrOut = "hdfs://10.0.18.98:8020/utsc/output/VLPartViewUser";
		...
		System.out.println("******");
		System.out.println("***Warming: This program could only compute one day's data in one time***");
		System.out.println("******");
		String calType = "0";
		String calNum = "0";
		String IPPort = "0";
		...
		if (IPPort.equals("0")) {
			...
			locationStrOut = "hdfs://" + IPPort + "/utsc/output/VLPartViewUser";
		}
